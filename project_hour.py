...
Original file is located at
    https://colab.research.google.com/drive/15AoxyuWUKR6LKXzCT4lSKKkW6X48sCBE
"""
...
import math
df2=df1.copy()
forecast_out = 60 # forcasting out 5% of the entire dataset
print(forecast_out)
...
print(r2,knn_mse,knn_mae)

gr=GradientBoostingRegressor()
gr.fit(X_train,y_train)
y_pred=gr.predict(X_test)
r2=gr.score(X_test,y_test)
gr_mse=mean_squared_error(y_test,y_pred)
gr_mae=mean_absolute_error(y_test,y_pred)
#pred=rf.predict(X_Predictions)
print(r2,gr_mse,gr_mae)

y_pred2=gr.predict(X_Predictions)

name='GradientBoostingRegressor' 
idx = pd.date_range('2022-11-29 10:02:00', periods=60, freq='T')

plt.rc('figure', figsize=(20, 8))
plt.plot(df[-700:-640].index, df[-700:-640]['Open'], label = "Test")
plt.plot(idx,y_pred2, lw=5, label = "Prediction")
plt.grid()
